                    ...
                    <table class="table">
                        ...
                        <?php
                            ...
                            if($query->num_rows > 0)
                            {
                                ...
                                {//colocado modal dentro da while
                                    $id = $usuario['id'];
                                    $tipo = $usuario['tipo'];
                                    echo '<tr>';
                        ...
                        ?>
                        <div class="modal fade" id="editaUsuario<?php echo $id; ?>" tabindex="0" aria-labelledby="editaUsuario" aria-hidden="true" data-bs-backdrop="false"><!--manda o nome da modal com os parametros e imprimindo o id então ele é chamado como variavel e seus parametros-->
